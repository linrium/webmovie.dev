            ...
            <div class="main__watch-episode">
                <ul>
                    ...
                    <li class="hvr-bounce-to-right list-episode-next">
                        ...
                        <div class="main__watch-suggest-episode"> <a href="">Episode {!! $episode['name'] !!}</a><small>5 views</small></div>
                    </li>
                    @endforeach
                </ul>
            </div>
    ...
    <div class="row main__watch-content">
        <div class="col-md-8">
            <div class="main__watch-info">
                <h1>{!! $movie['name'] !!}</h1>
                <div class="row">
                    <div class="col-md-8"><span id="follow"><i class="fa fa-heart"></i> {!! $movie['likes'] !!} likes</span></div>
                    <div class="col-md-4"><span id="views" class="hvr-underline-from-left"> {!! $movie['views'] !!} views</span></div>
                </div>
